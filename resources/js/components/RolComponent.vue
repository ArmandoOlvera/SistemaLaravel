    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i><h1>ROLES</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre del rol">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="email" id="descripcion" name="descripcion" class="form-control" placeholder="Descripcion">
                            </div>
                        </div>
