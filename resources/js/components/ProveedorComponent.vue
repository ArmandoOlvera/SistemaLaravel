            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Provedores
                              ...
                              <div class="form-group row">
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" v-model="contacto" class="form-control" placeholder="Ingrese el contacto de la persona">
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" v-model="telefono_contacto" class="form-control" placeholder="Ingrese el telefono de la persona">
...
swalWithBootstrapButtons.fire({
  title: 'Estas seguro de BORRAR el proveedor?',
